...
(function ($, core, undefined) {
    ...
    var BaseSelectbox = core.ui.View.extend({
        ...
        templates: {
            ...
            labelOption: '<span class="ui-select-text" _style="text-overflow: ellipsis;' +
                'width: 100%;display: inline-block;overflow: hidden;">{{text}}</span><span class="hide">선택됨</span><span class="ico"></span>'
        },
        ...
        _itemHTML: function (option, type) {
            ...
            if (!option) { return self.templated.notextOption(); }
            if (type === 'label') {
                return self.templated.labelOption(option);
            } else {
                return option.text;
            }
        },
    ...
    var CustomSelectbox = core.ui('CusomtSelectbox', BaseSelectbox, {
        ...
        _createList: function () {
            ...
            self.$list = $(self.templated.list({cid: self.cid}));
            ...
            self.$scrollbar = $(self.templated.scrollbar());
